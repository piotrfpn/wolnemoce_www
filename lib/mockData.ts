...
export const pricingPlans: PricingPlan[] = [
  ...
  {
    name: "Plan PRO",
    subtitle: "Dla aktywnych producentów (w przygotowaniu)",
    price: "299 zł",
    priceSuffix: "/ mies.",
    features: [
      "Większy limit ofert (np. do 5 aktywnych)",
    ...
    cta: "Skontaktuj się w sprawie Planu PRO",
    ctaHref: "/kontakt",
    isFeatured: true,
  },
  {
    ...
    features: [
      ...
      "Możliwość pakietu z Credos / LogiMarket",
    ],
    cta: "Wkrótce",
    ctaHref: "/kontakt",
  },
