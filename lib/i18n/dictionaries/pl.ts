...
const pl: Dictionary = {
  ...
  panel: {
    ...
    nav: {
      ...
      myInterests: "Moje zainteresowania",
      myRequests: "Moje zapytania produkcyjne",
      settings: "Ustawienia",
    },
    myInterests: {
      title: "Moje zainteresowania",
      description: "Zapytania produkcyjne, do których Twoja firma zgłosiła zainteresowanie realizacją.",
      emptyStateTitle: "Nie masz jeszcze zgłoszeń zainteresowania.",
      emptyStateDescription: "Gdy zgłosisz zainteresowanie realizacją zapytania produkcyjnego, zobaczysz je tutaj.",
      viewRequest: "Zobacz zapytanie",
      requestNotActive: "Zapytanie nie jest już aktywne",
      interestedAt: "Zgłoszono",
      statusDraft: "Szkic",
      ...
      loadError: "Nie udało się wczytać zainteresowań. Spróbuj ponownie później.",
    },
    ...
    profile: {
      ...
      companyCountryLabel: "Kraj firmy",
      countryPL: "Polska",
      countryDE: "Niemcy",
      countryCZ: "Czechy",
      countrySK: "Słowacja",
      ...
      registrationNumberPlaceholder: "Np. HRB 12345",
      registeredAddressLabel: "Adres rejestrowy firmy",
      registeredAddressPlaceholder: "Np. Musterstraße 1, 12345 Berlin",
      voivodeshipForeignLabel: "Region / Stan / Województwo",
      voivodeshipForeignPlaceholder: "Region / Stan / Prowincja",
      foreignVerificationNotice: "Dane firm zagranicznych są weryfikowane ręcznie przez administratora. Profil i oferty staną się publiczne po zatwierdzeniu danych rejestrowych.",
      voivodeshipPlLabel: "Województwo",
      voivodeshipSelectPlaceholder: "Wybierz województwo",
      cityLabel: "Miasto",
      cityPlaceholder: "Np. Poznań, Kalisz, Leszno",
      descriptionLabel: "Opis firmy",
      descriptionPlaceholder: "Opisz specjalizację, park maszynowy, doświadczenie lub typ klientów.",
      nipPlaceholder: "Np. 1234567890",
      companyNamePlaceholder: "Np. MetalPol Sp. z o.o.",
      websitePlaceholder: "https://twojafirma.pl",
      rfqEmailPlaceholder: "oferty@twojafirma.pl",
      mainIndustryLabel: "Branża główna",
      mainIndustryPlaceholder: "Wybierz branżę główną",
      servicesSectionTitle: "Rodzaje usług",
      servicesSectionDescription: "Wybierz usługi, które najlepiej opisują możliwości Twojej firmy. Możesz zaznaczyć kilka pozycji z wielu branż.",
      servicesEmptyIndustries: "Najpierw wybierz branże działalności, aby zobaczyć dostępne rodzaje usług.",
      gusNotice: "Dane pobrane z rejestru GUS są zapisywane dopiero po zapisaniu profilu firmy.",
      regonLabel: "REGON",
      krsLabel: "KRS",
      postalCodeLabel: "Kod pocztowy",
      postalCodePlaceholder: "Np. 00-000",
      streetAddressLabel: "Ulica / adres",
      streetAddressPlaceholder: "Np. ul. Testowa 1/2",
      fullAddressLabel: "Pełny adres siedziby",
      fullAddressPlaceholder: "Np. ul. Testowa 1/2, 00-000 Warszawa",
      legalFormLabel: "Forma prawna",
      businessStatusLabel: "Status działalności",
      primaryPkdLabel: "PKD przeważające",
      pkdCodesLabel: "PKD",
      publicProfileFallback: "Publiczny profil firmy zostanie utworzony po zapisaniu profilu.",
      ...
      accountEmailMissing: "Brak adresu e-mail",
      websiteInvalid: "Podaj poprawny adres strony internetowej.",
      nipInvalidChecksum: "Podaj poprawny NIP z prawidłową sumą kontrolną.",
      taxIdRequired: "Podaj VAT ID / Tax ID.",
      companyNameRequired: "Podaj nazwę firmy.",
      industryRequired: "Wybierz co najmniej jedną branżę działalności.",
      mainIndustryInvalid: "Branża główna musi być jedną z wybranych branż działalności.",
      serviceTypeRequired: "Wybierz co najmniej jeden rodzaj usługi.",
      voivodeshipRequired: "Wybierz województwo.",
      foreignRegionRequired: "Podaj region / stan / województwo.",
      cityRequired: "Podaj miasto.",
      rfqEmailInvalid: "Podaj poprawny adres e-mail do zapytań ofertowych albo pozostaw pole puste.",
      profileSaveError: "Nie udało się zapisać danych. Sprawdź formularz i spróbuj ponownie.",
      nipAlreadyRegistered: "Firma z tym NIP jest już zarejestrowana w systemie.",
      taxIdAlreadyRegistered: "Firma z tym VAT ID / Tax ID dla wybranego kraju jest już zarejestrowana w systemie.",
      nipAlreadyAssigned: "Firma z tym NIP jest już przypisana do Twojego konta. Użyjemy jej do dodania oferty.",
      taxIdAlreadyAssigned: "Firma z tym VAT ID / Tax ID dla wybranego kraju jest już przypisana do Twojego konta. Użyjemy jej do dodania oferty.",
      profileSavedReverificationRequired: "Dane firmy zostały zapisane. Zmiana danych publicznych wymaga ponownej weryfikacji.",
      contactEmailSaveError: "Dane firmy zapisano, ale nie udało się zapisać e-maila kontaktowego. Spróbuj ponownie.",
      gusLookupInvalidNip: "Podaj prawidłowy NIP składający się z 10 cyfr.",
      gusNoData: "Nie udało się pobrać danych z GUS. Możesz uzupełnić dane ręcznie.",
      gusNoChanges: "Formularz nie wymagał automatycznego uzupełnienia pól.",
      gusExistingFieldsPreserved: "Część pól była już uzupełniona, dlatego nie została automatycznie nadpisana.",
      serviceRequestIndustryRequired: "Wybierz branżę, której dotyczy zgłoszenie.",
      serviceRequestNameTooShort: "Proponowana nazwa usługi musi mieć co najmniej 3 znaki.",
      serviceRequestError: "Nie udało się wysłać zgłoszenia. Spróbuj ponownie.",
      presentationSizeMissing: "Brak danych",
      presentationFileTooLarge: "Plik jest za duży. Maksymalny rozmiar to 10 MB.",
      presentationInvalidFormat: "Dozwolone formaty to PDF, PPT lub PPTX.",
      presentationFileRequired: "Wybierz plik prezentacji firmy.",
      presentationUploadError: "Nie udało się przesłać prezentacji. Spróbuj ponownie.",
      presentationUpdateError: "Nie udało się zapisać danych prezentacji. Spróbuj ponownie.",
      presentationDeleteError: "Nie udało się usunąć prezentacji. Spróbuj ponownie.",
      // Presentation keys
