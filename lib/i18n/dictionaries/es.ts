...
const es: Dictionary = {
  ...
  hero: {
    ...
    ctaPrimary: "Añadir oferta",
    ctaSecondary: "Añadir consulta",
  ...
  companiesList: {
    ...
    searchPlaceholder: "Nombre o descripción de la empresa",
    country: "País",
  ...
  panel: {
    ...
    myInterests: {
      title: "Mis intereses",
      description: "Solicitudes de producción en las que su empresa ha expresado interés.",
      emptyStateTitle: "Aún no hay intereses.",
      emptyStateDescription: "Cuando exprese interés en una solicitud de producción, la verá aquí.",
      viewRequest: "Ver solicitud",
      requestNotActive: "La solicitud ya no está activa",
      interestedAt: "Expresado el",
      ...
      loadError: "No se pudieron cargar los intereses. Inténtalo de nuevo más tarde.",
    },
    ...
    profile: {
      ...
      companyCountryLabel: "País de la empresa",
      countryPL: "Polonia",
      countryDE: "Alemania",
      ...
      countryCN: "China",
      countryXX: "Otros países",
      taxIdLabel: "NIF-IVA / Identificación fiscal",
      taxIdPlaceholder: "Ej. DE123456789",
      registrationNumberLabel: "Número de registro de la empresa",
      registrationNumberPlaceholder: "Ej. HRB 12345",
      registeredAddressLabel: "Dirección registrada de la empresa",
      registeredAddressPlaceholder: "Ej. Musterstraße 1, 12345 Berlín",
      voivodeshipForeignLabel: "Región / Estado / Provincia",
      voivodeshipForeignPlaceholder: "Región / Estado / Provincia",
      foreignVerificationNotice: "Los datos de las empresas extranjeras se verifican manualmente por el administrador. El perfil y las ofertas se publicarán una vez aprobados los datos de registro.",
      voivodeshipPlLabel: "Voivodato",
      voivodeshipSelectPlaceholder: "Seleccionar voivodato",
      cityLabel: "Ciudad",
      cityPlaceholder: "Ej. Poznań, Kalisz, Leszno",
      descriptionLabel: "Descripción de la empresa",
      descriptionPlaceholder: "Describa la especialización, maquinaria, experiencia o tipos de clientes.",
      nipPlaceholder: "Ej. 1234567890",
      companyNamePlaceholder: "Ej. MetalPol Sp. z o.o.",
      websitePlaceholder: "https://suempresa.es",
      rfqEmailPlaceholder: "consultas@suempresa.es",
      mainIndustryLabel: "Sector principal",
      mainIndustryPlaceholder: "Seleccionar sector principal",
      servicesSectionTitle: "Tipos de servicios",
      servicesSectionDescription: "Seleccione los servicios que mejor describan las capacidades de su empresa. Puede seleccionar varios elementos de múltiples sectores.",
      servicesEmptyIndustries: "Primero seleccione los sectores de actividad para ver los tipos de servicios disponibles.",
      gusNotice: "Los datos obtenidos del registro GUS solo se guardan después de guardar el perfil de la empresa.",
      regonLabel: "REGON",
      krsLabel: "KRS",
      postalCodeLabel: "Código postal",
      postalCodePlaceholder: "Ej. 00-000",
      streetAddressLabel: "Calle / dirección",
      streetAddressPlaceholder: "Ej. ul. Testowa 1/2",
      fullAddressLabel: "Dirección registrada completa",
      fullAddressPlaceholder: "Ej. ul. Testowa 1/2, 00-000 Warszawa",
      legalFormLabel: "Forma jurídica",
      businessStatusLabel: "Estado de la actividad",
      primaryPkdLabel: "PKD principal",
      pkdCodesLabel: "PKD",
      publicProfileFallback: "El perfil público de la empresa se creará después de guardar el perfil.",
      ...
      accountEmailMissing: "Sin dirección de correo electrónico",
      websiteInvalid: "Introduzca una dirección web válida.",
      nipInvalidChecksum: "Introduzca un NIP válido con la suma de comprobación correcta.",
      taxIdRequired: "Introduzca el número de IVA / identificador fiscal.",
      companyNameRequired: "Introduzca el nombre de la empresa.",
      industryRequired: "Seleccione al menos un sector de actividad.",
      mainIndustryInvalid: "El sector principal debe ser uno de los sectores seleccionados.",
      serviceTypeRequired: "Seleccione al menos un tipo de servicio.",
      voivodeshipRequired: "Seleccione un voivodato.",
      foreignRegionRequired: "Introduzca una región / estado / provincia.",
      cityRequired: "Introduzca una ciudad.",
      rfqEmailInvalid: "Introduzca una dirección de correo válida para consultas o deje el campo vacío.",
      profileSaveError: "No se pudieron guardar los datos. Revise el formulario e inténtelo de nuevo.",
      nipAlreadyRegistered: "Ya existe una empresa registrada con este NIP.",
      taxIdAlreadyRegistered: "Ya existe una empresa registrada con este número de IVA / identificador fiscal para el país seleccionado.",
      nipAlreadyAssigned: "Una empresa con este NIP ya está asignada a su cuenta. La utilizaremos al añadir una oferta.",
      taxIdAlreadyAssigned: "Una empresa con este número de IVA / identificador fiscal para el país seleccionado ya está asignada a su cuenta. La utilizaremos al añadir una oferta.",
      profileSavedReverificationRequired: "Los datos de la empresa se han guardado. Los cambios en los datos públicos requieren una nueva verificación.",
      contactEmailSaveError: "Los datos de la empresa se guardaron, pero no se pudo guardar el correo de contacto. Inténtelo de nuevo.",
      gusLookupInvalidNip: "Introduzca un NIP válido de 10 dígitos.",
      gusNoData: "No se pudieron obtener los datos de GUS. Puede completar los campos manualmente.",
      gusNoChanges: "El formulario no requería completar ningún campo automáticamente.",
      gusExistingFieldsPreserved: "Algunos campos ya estaban completados y no se sobrescribieron automáticamente.",
      serviceRequestIndustryRequired: "Seleccione el sector relacionado con la solicitud.",
      serviceRequestNameTooShort: "El nombre del servicio propuesto debe tener al menos 3 caracteres.",
      serviceRequestError: "No se pudo enviar la solicitud. Inténtelo de nuevo.",
      presentationSizeMissing: "Sin datos",
      presentationFileTooLarge: "El archivo es demasiado grande. El tamaño máximo es de 10 MB.",
      presentationInvalidFormat: "Los formatos permitidos son PDF, PPT y PPTX.",
      presentationFileRequired: "Seleccione un archivo de presentación de la empresa.",
      presentationUploadError: "No se pudo subir la presentación. Inténtelo de nuevo.",
      presentationUpdateError: "No se pudieron guardar los datos de la presentación. Inténtelo de nuevo.",
      presentationDeleteError: "No se pudo eliminar la presentación. Inténtelo de nuevo.",
    },
    inquiries: {
      title: "Consultas",
