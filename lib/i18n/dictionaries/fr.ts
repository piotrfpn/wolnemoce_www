...
const fr: Dictionary = {
  ...
  companiesList: {
    ...
    searchPlaceholder: "Nom ou description de l'entreprise",
    country: "Pays",
  ...
  panel: {
    ...
    myInterests: {
      title: "Mes intérêts",
      description: "Demandes de production pour lesquelles votre entreprise a exprimé son intérêt.",
      emptyStateTitle: "Aucun intérêt pour le moment.",
      emptyStateDescription: "Lorsque vous exprimerez votre intérêt pour une demande de production, vous la verrez ici.",
      viewRequest: "Voir la demande",
      requestNotActive: "La demande n'est plus active",
      interestedAt: "Exprimé le",
      statusDraft: "Brouillon",
      statusPending: "En modération",
      statusActive: "Actif",
      statusRejected: "Rejeté",
      statusExpired: "Expiré",
      statusArchived: "Archivé",
      loadError: "Impossible de charger les intérêts. Veuillez réessayer plus tard.",
    },
