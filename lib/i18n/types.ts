export type Dictionary = {
  ...
  companyInquiry: {
    ...
    senderCompanyNameLabel: string;
    senderCompanyNamePlaceholder: string;
    senderEmailLabel: string;
    senderEmailPlaceholder: string;
    senderPhoneLabel: string;
    senderPhoneOptional: string;
  ...
  panel: {
    ...
    profile: {
      ...
      voivodeshipForeignLabel: string;
      voivodeshipForeignPlaceholder: string;
      foreignVerificationNotice: string;
      voivodeshipPlLabel: string;
      voivodeshipSelectPlaceholder: string;
      cityLabel: string;
      ...
      rfqEmailPlaceholder: string;
      mainIndustryLabel: string;
      mainIndustryPlaceholder: string;
      servicesSectionTitle: string;
      servicesSectionDescription: string;
      servicesEmptyIndustries: string;
      gusNotice: string;
      regonLabel: string;
      krsLabel: string;
      ...
      primaryPkdLabel: string;
      pkdCodesLabel: string;
      ...
      accountEmailMissing: string;
      websiteInvalid: string;
      nipInvalidChecksum: string;
      taxIdRequired: string;
      companyNameRequired: string;
      industryRequired: string;
      mainIndustryInvalid: string;
      serviceTypeRequired: string;
      voivodeshipRequired: string;
      foreignRegionRequired: string;
      cityRequired: string;
      rfqEmailInvalid: string;
      profileSaveError: string;
      nipAlreadyRegistered: string;
      taxIdAlreadyRegistered: string;
      nipAlreadyAssigned: string;
      taxIdAlreadyAssigned: string;
      profileSavedReverificationRequired: string;
      contactEmailSaveError: string;
      gusLookupInvalidNip: string;
      gusNoData: string;
      gusNoChanges: string;
      gusExistingFieldsPreserved: string;
      serviceRequestIndustryRequired: string;
      serviceRequestNameTooShort: string;
      serviceRequestError: string;
      presentationSizeMissing: string;
      presentationFileTooLarge: string;
      presentationInvalidFormat: string;
      presentationFileRequired: string;
      presentationUploadError: string;
      presentationUpdateError: string;
      presentationDeleteError: string;
      // Presentation keys
