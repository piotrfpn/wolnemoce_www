...
export const metadata: Metadata = {
  ...
  description:
    "Polityka prywatności WolneMoce.pl opisująca przetwarzanie danych w portalu B2B, RFQ, załącznikach, Supabase, Vercel i Stripe.",
};
    ...
    <>
      ...
      <main>
        <PageHero
          ...
          title="Polityka prywatności"
          description="Informacje o przetwarzaniu danych osobowych w portalu WolneMoce.pl."
