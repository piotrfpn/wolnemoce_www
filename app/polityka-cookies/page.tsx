...
export const metadata: Metadata = {
  ...
  description:
    "Polityka cookies WolneMoce.pl opisująca cookies techniczne, sesyjne, bezpieczeństwa, Stripe i analitykę opcjonalną.",
};
    ...
    <>
      ...
      <main>
        <PageHero
          ...
          title="Polityka Cookies"
          description="Informacje o plikach cookies i podobnych technologiach wykorzystywanych w WolneMoce.pl."
